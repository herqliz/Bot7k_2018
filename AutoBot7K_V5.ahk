...
iniRead, mainSleep, %A_WorkingDir%\Config.ini, Common, ESCTYPE
...
Skill1() {
ControlClick,x466 y540, ahk_id %hwnd%
...
Skill2() {
ControlClick,x466 y592, ahk_id %hwnd% 
...
Skill3() {
ControlClick,x542 y535, ahk_id %hwnd%
...
Skill4() {
ControlClick,x540 y590, ahk_id %hwnd%
...
Skill5() {
ControlClick,x612 y540, ahk_id %hwnd%
...
Skill6() {
ControlClick,x612 y590, ahk_id %hwnd%
...
Skill7() {
ControlClick,x690 y542, ahk_id %hwnd%
...
Skill8() {
ControlClick,x690 y591, ahk_id %hwnd%
...
Skill9() {
ControlClick,x764 y540, ahk_id %hwnd%
...
Skill10() {
ControlClick,x764 y590, ahk_id %hwnd% 
...
Skill15() {
ControlClick,x778 y480, ahk_id %hwnd% 
...
GetHwnd() {
 ...
 PrintLog("INFO-HWND> NoxTitleName="NoxTitleName)
  IfWinExist, %NoxTitleName%
 {
   WinActivate
   hwnd := WinExist("ahk_class Qt5QWindowIcon")
   PrintLog("INFO-HWND> HWND FROM CLASS = "hwnd,1)
   return 1
 }
 IfWinExist, %NoxTitleName%
 {
   WinActivate
   hwnd := WinExist("A")
   PrintLog("INFO-HWND> HWND FROM TITLE NAME MATCH = "hwnd,1)
   return 1
 }

 
   hwnd := WinExist("ahk_class Qt5QWindowIcon")
   PrintLog("INFO-HWND> HWND FROM Exception case = "hwnd,1)
return 1
}
...
OpenGame(Timeout="180") {
 ...
 if (SearchScreen("Img\Game.png",1,5,"INFO-OPENING GAME","INFO-GAME IS OPENNING ... OK")) {
  ...
  While !(SearchScreen("Img\Home-Adventure1.png",0,1,"INFO-HOME SCREEN NOW","INFO-NOT HOME SCREEN")) { 
	...
	SearchScreen("Img\Closeadx.png",1,1,"INFO-Click Close Ad","")
       ...
       if (ChangeEasyMap=0){
         if (SearchScreen("Img\MapAsGarNormal.png",1,3,"INFO-STAGE> CLICK ASGAR NORMAL","") or SearchScreen("Img\MapAsGarNormal1.png",1,3,"INFO-STAGE> CLICK ASGAR NORMAL","") or SearchScreen("Img\MapAsGarNormal2.png",1,3,"INFO-STAGE> CLICK ASGAR NORMAL","")) {
           if (SearchScreen("Img\MapAsGarNormalEasy.png",1,3,"INFO-STAGE> CLICK EASY","") or SearchScreen("Img\MapAsGarNormalEasy1.png",1,3,"INFO-STAGE> CLICK EASY","")) {
             ...
             ControlClick,x95 y571, ahk_id %hwnd% 
             ChangeEasyMap=1
           }
         }
       }
     ...
     if (SearchScreen("Img\StageReady.png",1,5,"INFO-STAGE> CLICK READY","WARNING-STAGE> NOT FOUND READY BUTTON-StageReady.png") or SearchScreen("Img\StageReady1.png",1,5,"INFO-STAGE> CLICK READY","WARNING-STAGE> NOT FOUND READY BUTTON-StageReady.png")) {
	   ...
	   if (TeamtoFight="A") {
		   if !(SearchScreen("Img\TeamASelected.png",1,3,"INFO-STAGE> CLICK TEAM A","WARNING-STAGE>NOT FOUND TEAM A-TeamCSelected.png ... TRY PIRCURE2") or SearchScreen("Img\ClickTeamA.png",1,3,"INFO-STAGE> CLICK TEAM A","WARNING-STAGE>NOT FOUND TEAM C-ClickTeamC.png ... TRY PIRCURE2") or SearchScreen("Img\TowerTeamA.png",1,3,"INFO-STAGE> CLICK TEAM C","WARNING-STAGE>NOT FOUND TEAM C-TowerTeamC.png ... FORCE CLICK POSITION")) {
			 ControlClick,x123 y154, ahk_id %hwnd%
		   }
	   } else {   
		   if !(SearchScreen("Img\TeamCSelected.png",1,3,"INFO-STAGE> CLICK TEAM C","WARNING-STAGE>NOT FOUND TEAM C-TeamCSelected.png ... TRY PIRCURE2") or SearchScreen("Img\ClickTeamC.png",1,3,"INFO-STAGE> CLICK TEAM C","WARNING-STAGE>NOT FOUND TEAM C-ClickTeamC.png ... TRY PIRCURE2") or SearchScreen("Img\TowerTeamC.png",1,3,"INFO-STAGE> CLICK TEAM C","WARNING-STAGE>NOT FOUND TEAM C-TowerTeamC.png ... FORCE CLICK POSITION")) {
			 ControlClick,x298 y154, ahk_id %hwnd%
		   }
	   }
       if !(AISwitchHero()) {
        NumErrorFarm++ 
...
ForceClickDragon(){
ControlClick,x557 y183, ahk_id %hwnd%
sleep 300
ControlClick,x557 y183, ahk_id %hwnd%
...
ControlClick,x724 y592, ahk_id %hwnd%
...
ForceClickTower(){
ControlClick,x736 y164, ahk_id %hwnd%
sleep 300
ControlClick,x736 y164, ahk_id %hwnd%
...
ForceClickRaidNew(){
ControlClick,x558 y192, ahk_id %hwnd%
...
ForceClickArena(){
ControlClick,x555 y467, ahk_id %hwnd%
sleep 300
  ...
  if ((FightLeader != ArenaLeader) or (DragonLeader != ArenaLeader)) {
   ...
   if (ForceClickArena() or SearchScreen("Img\Arena.png",1,4,"INFO-ARENA> CLICK ARENA","WARNING-ARENA> NO ARENA BUTTON-Arena.png") or SearchScreen("Img\Arena1.png",1,3,"INFO-ARENA> CLICK ARENA","WARNING-ARENA> NO ARENA BUTTON-Arena1.png") ) {
      ...
      if !(SearchScreen("Img\ArenaReady.png",1,5,"INFO-ARENA> CLICK READY","WARNING-ARENA> NOT FOUND READY BUTTON-ArenaReady.png") or SearchScreen("Img\ArenaReady1.png",1,5,"INFO-ARENA> CLICK READY","WARNING-ARENA> NOT FOUND READY BUTTON-ArenaReady.png")) { 
		 ControlClick,x624 y457, ahk_id %hwnd%
	  } 
...
isHero1LV30() {
 ...
 if (NotChangeHero1=0) {
	 if (PixelColor(154,267,hwnd)="0xD97200") or (PixelColor(152,245,hwnd)="0xF7C41F") {
	  NumHeroMatch++
	 }
	 if (PixelColor(164,266,hwnd)="0xEE8C07") or (PixelColor(154,249,hwnd)="0xF79A07") {
	  NumHeroMatch++
	 }
	 if (PixelColor(160,267,hwnd)="0xEC8203") or (PixelColor(152,254,hwnd)="0xE98003") {
	  NumHeroMatch++
	 }
	 if (PixelColor(153,272,hwnd)="0xC36600" ) or (PixelColor(152,254,hwnd)="0xE98003") {
	  NumHeroMatch++
	 }
	 if (PixelColor(153,262,hwnd)="0xEFAF10" ) or (PixelColor(160,248,hwnd)="0xF79805"){
	  NumHeroMatch++
	 }
...
NumHeroMatch:=0
 ...
 if (NotChangeHero2=0) {
	 if (PixelColor(152,357,hwnd)="0xDA940A" ) or (PixelColor(153,336,hwnd)="0xD5960C" ) {
	  NumHeroMatch++
	 }
	 if (PixelColor(154,361,hwnd)="0xEC8904") or (PixelColor(154,340,hwnd)="0xEE8C04" ){
	  NumHeroMatch++
	 }
	 if (PixelColor(153,366,hwnd)="0xE68C04") or (PixelColor(151,344,hwnd)="0xF98C05" ){
	  NumHeroMatch++
	 }
	 if (PixelColor(160,359,hwnd)="0xF9C08" ) or (PixelColor(160,341,hwnd)="0xE97D01" ) {
	  NumHeroMatch++
	 }
	 if (NumHeroMatch>=2) {
	   Hero2Lv30Flag=1
...
isHero3LV30() {
 NumHeroMatch:=0
  if (NotChangeHero3=0) {
	 if (PixelColor(152,451,hwnd)="0xCA7D02") or (PixelColor(153,426,hwnd)="0xD5960C" ){
	  NumHeroMatch++
	 }
	 if (PixelColor(153,455,hwnd)="0xE38002") or (PixelColor(154,430,hwnd)="0xEE8C04" ){
	  NumHeroMatch++
	 }
	 if (PixelColor(151,459,hwnd)="0xF68904") or (PixelColor(151,434,hwnd)="0xF98C05" ){
	  NumHeroMatch++
	 }
	 if (PixelColor(160,455,hwnd)="0xEF8604" ) or (PixelColor(160,431,hwnd)="0xE87D01" ){
	  NumHeroMatch++
	 }
	 if (NumHeroMatch>=2) {
	   Hero3Lv30Flag=1
...
isHero4LV30() {
 NumHeroMatch:=0
  if (NotChangeHero4=0) {
	 if (PixelColor(152,546,hwnd)="0xDA940A") or (PixelColor(151,518,hwnd)="0xF2B613" ) {
	  NumHeroMatch++
	 }
	 if (PixelColor(153,546,hwnd)="0xBE8109") or (PixelColor(154,520,hwnd)="0xC99411" ) {
	  NumHeroMatch++
	 }
	 if (PixelColor(153,550,hwnd)="0xED9306") or (PixelColor(151,525,hwnd)="0xF69208" ) {
	  NumHeroMatch++
	 }
	 if (PixelColor(152,555,hwnd)="0xE27B02" ) or (PixelColor(160,520,hwnd)="0xF79906" ) {
	  NumHeroMatch++
	 }
	 if (PixelColor(160,550,hwnd)="0xF18A04" ) or (PixelColor(164,522,hwnd)="0xED8907" )  {
	  NumHeroMatch++
	 }
	 if (NumHeroMatch>=2) {
	   Hero4Lv30Flag=1
...
MonSwitch(x,y,m1,m2) {
  PrintLog("INFO-FARM> Try to Click HERO",1)
  sleep 1000
  ControlClick,x%m1% y%m2%
  PrintLog("INFO-FARM> Click HERO ... DONE",1)
  if (SearchScreen("Img\FarmHero1.png",0,1,"INFO-FARM> HERO LEVEL 1","INFO-FARM> MON NOT LEVEL1") and (SearchScreen("Img\FarmJoin.png",0,1,"INFO-FARM> CAN SELECT","ERROR-FARM> NO JOIN BUTTON") or SearchScreen("Img\FarmJoin1.png",0,1,"INFO-FARM> CAN SELECT","ERROR-FARM> NO JOIN BUTTON")))  {
      SearchScreen("Img\FarmJoin.png",1,1,"INFO-FARM> CLICK JOIN","ERROR-FARM> NOT FOUND JOIN ")
      if (SearchScreen("Img\FarmArrowUp.png",0,4,"INFO-FARM> ARROW UP","") or SearchScreen("Img\FarmArrowUp1.png",0,4,"INFO-FARM> ARROW UP","") ) {
        ...
        ControlClick,x%x% y%y%, ahk_id %hwnd%
        if (SearchScreen("Img\FarmHero1.png",0,1,"INFO-FARM> HERO LEVEL 1","INFO-FARM> HERO LEVEL NOT 1")) {
      ...
      ControlSend,, {ESC}, ahk_id %hwnd%
	  PrintLog("INFO-FARM> ESC CLICK",1)
      return 0
    }
return 0
}
...
ChangeHero(x,y) {
 ...
 roundHero++
  loop,2 {
    if(MonSwitch(x,y,321,237)) {
     return 1
    } else {
     if(MonSwitch(x,y,427,244)) {
       return 1
     } else {
       if(MonSwitch(x,y,529,244)) {
        return 1
       } else {
        if(MonSwitch(x,y,636,244)) {
          return 1
        } else {
          if(MonSwitch(x,y,737,244)) {
            return 1
		  }
         }
       }
    ...
    modR:=mod(roundHero,2)
  	if (modR = 0) {
    ControlClick,x560 y575, ahk_id %hwnd%
	sleep 1000
	} else {
	ControlClick,x437 y575, ahk_id %hwnd%
	sleep 1000
	}
